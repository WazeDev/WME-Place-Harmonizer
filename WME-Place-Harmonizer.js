...
(function () {
    ...
    GM_addStyle([
        ...
        '.wmeph-fat-btn { padding-left:10px; padding-right:10px; padding-top:4px; margin-right:4px; display:inline-block; font-weight:normal; height:24px}',
    ...
    var devVersStr= isDevVersion ? 'Beta' : '';  // strings to differentiate DOM elements between regular and beta script
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            callAjax('https://spreadsheets.google.com/feeds/list/1L82mM8Xg-MvKqK3WOfsMhFEGmVM46lA8BVcx8qwgmA8/ofblgob/public/values', response => {
    ...
    function runPH() {
        ...
        function harmonizePlaceGo(item, useFlag, actions) {
            ...
            var region, state2L, newPlaceURL, approveRegionURL;
            var gFormState = '';
            ...
            bannButt = {
                ...
                plaIsPublic: { // no WL
                    active: false, severity: 0, message: 'If this does not meet the requirements for a <a href="https://wazeopedia.waze.com/wiki/USA/Places/Parking_lot#Lot_Type" target="_blank" style="color:5a5a73">public parking lot</a>, change to:<br>'
                ...
                extProviderMissing: {
                    active:false, severity:3, message:'No Google link', value:'Nudge', title:'If no other properties need to be updated, click to nudge the place (force an edit).',
                    action: function() {
                        var place = getSelectedFeatures()[0];
                        // Use an exact clone of the original geometry to force an edit without actually changing anything.
                        var newGeom = place.geometry.clone();
...
//                 }
        ...
        function displayRunButton() {
            ...
            setTimeout(() => {
                ...
                if ($('#runWMEPH').length === 0 ) {
                    let devVersSuffix = isDevVersion ? '-β' : '';
        ...
        // This is used to skip a couple things if already run once.  This could probably be handled better...
        let initAlreadyRun = false;
        ...
        function initShortcutKey() {
            ...
            if (!initAlreadyRun) shortcut.add(modifKey + shortcutParse, function() { harmonizePlace(); });
        ...
        function initWmephTab() {
            ...
            if (!initAlreadyRun && $('#WMEPH-ColorHighlighting').prop('checked') ) {
        ...
        function phlogdev(msg, obj) {
            if (devUser) {
                console.log('WMEPH' + (isDevVersion ? '-β' : '') + ': ' + msg, (obj ? obj : ''));
            }
        }
    } // END runPH Function
    ...
    function phlog(m) {
        ...
        console.log('WMEPH' + (isDevVersion ? '-β' : '') + ': ' + m);
    }
