...
const IS_DEV_VERSION = /Beta/i.test(SCRIPT_NAME); //  enables dev messages and unique DOM options if the script is called "... Beta"
const DEV_VERSION_STR = IS_DEV_VERSION ? 'Beta' : ''; // strings to differentiate DOM elements between regular and beta script
...
const PM_USER_LIST = { // user names and IDs for PM functions
...
const WME_SERVICES_ARRAY = ['VALLET_SERVICE', 'DRIVETHROUGH', 'WI_FI', 'RESTROOMS', 'CREDIT_CARDS', 'RESERVATIONS', 'OUTSIDE_SEATING',
    'AIR_CONDITIONING', 'PARKING_FOR_CUSTOMERS', 'DELIVERIES', 'TAKE_AWAY', 'SECURITY', 'EV_CHARGING_STATION', 'WHEELCHAIR_ACCESSIBLE', 'DISABILITY_PARKING'];
...
function getHoursHtml(label, defaultText) {
    defaultText = defaultText || DEFAULT_HOURS_TEXT;
    return $('<span>').append(
        `${label}:`,
        $('<input>', {
...
function phlog(msg) {
    console.log(`WMEPH${IS_DEV_VERSION ? '-β' : ''}:`, msg);
}
function phlogdev(msg) {
    if (USER.isDevUser) {
        console.log(`WMEPH${IS_DEV_VERSION ? '-β' : ''} (dev):`, msg);
    }
}
...
function appendServiceButtonIconCss() {
    const cssArray = [
        ...
        '.serv-security { width: 50px, height: 50px; display: inline-block; background: transparent url(data:image/svg+xml;base64,) top center no-repeat; }',
        '.serv-evcharging { width: 50px, height: 50px, display: inline-block; background: transparent url(data:image/png;base64,) top center no-repeat; }'
    ];
...
function harmoList(itemName, state2L, region3L, country, itemCats, item) {
    ...
    PNH_DATA[country].newPnh.forEach(pnhEntry => {
...
function harmonizePlace() {
    ...
    if (IS_DEV_VERSION && !USER.isBetaUser) {
...
const Flag = {
    ...
    RestAreaSpec: class extends WLActionFlag {
        ...
        action() {
            ...
            _servicesBanner.addParking.actionOn(actions);
            _servicesBanner.addWheelchair.actionOn(actions);
    ...
    BankBranch: class extends ActionFlag {
        ...
        action() {
            ...
            if (name !== venue.attributes.name) UPDATED_FIELDS.name.updated = true;
            UPDATED_FIELDS.categories.updated = true;
            harmonizePlaceGo(venue);
        }
    },
    ...
    LockRPP: class extends ActionFlag {
        constructor(lockLevel, defaultLockLevel) {
            super(0, `Current lock: ${lockLevel + 1}. Lock at ${defaultLockLevel + 1} ?`, 'Lock', 'Lock the residential point');
        ...
        action() {
            const venue = getSelectedVenue();
            addUpdateAction(venue, { lockRank: this.defaultLockLevel });
            harmonizePlaceGo(venue);
        }
    },
    ...
    AddCat2: class extends ActionFlag {
        constructor(catId) {
            super(0, `Is there a ${_catTransWaze2Lang[catId]} at this location?`, 'Yes', `Add ${_catTransWaze2Lang[catId]}`);
            this.altCategory = catId;
        }

        static eval(pnhMatch, categories) {
            const result = { flag: null };
            const altCat = pnhMatch.altCategories[0];
            if (pnhMatch.buttOn && pnhMatch.buttOn.includes('addCat2') && !categories.includes(altCat)) {
                result.flag = new Flag.AddCat2(altCat);
            }
            return result;
        }
    ...
    ApprovalSubmit: class extends ActionFlag {
        ...
        action() {
            if (PM_USER_LIST.hasOwnProperty(this.region) && PM_USER_LIST[this.region].approvalActive) {
                const forumPMInputs = {
                    ...
                    message: `Please approve "${this.pnhNameTemp}" for the ${this.region} region.  Thanks\n \nPNH order number: ${
                        this.pnhOrderNum}\n \nPermalink: ${this.placePL}\n \nPNH Link: ${URLS.usaPnh}`,
                    preview: 'Preview',
                    attach_sig: 'on'
                };
                forumPMInputs[`address_list[u][${PM_USER_LIST[this.region].modID}]`] = 'to'; // Sends a PM to the regional mod instead of the submission form
    ...
    StoreFinder: class extends ActionFlag {
        ...
        action() {
            ...
            if (localStorage.getItem(SETTING_IDS.sfUrlWarning) === '0' && this.isLocalizedUrl) {
                linkProceed = false;
            ...
            if (linkProceed) {
                if ($('#WMEPH-WebSearchNewTab').prop('checked')) {
                    ...
                    window.open(this.url, SEARCH_RESULTS_WINDOW_NAME, _searchResultsWindowSpecs);
                }
            }
        }
    }
        ...
        PlaceErrorForumPost: {
            ...
            action() {
                reportError({
                    ...
                    message: `Script version: ${SCRIPT_VERSION}${DEV_VERSION_STR}\nPermalink: ${
...
function harmonizePlaceGo(item, highlightOnly = false, actions = null) {
    ...
    if (flag && flag.newName) newName = flag.newName;
    ...
    if (item.attributes.residential) {
        ...
        if (!highlightOnly) {
            if (!item.isParkingLot()) {
                ...
                matchResult = harmoList(newName, state2L, region, countryCode, newCategories, item);
            ...
            switch (region) {
                ...
                case 'CA_EN': regionFormURL = 'https://docs.google.com/forms/d/13JwXsrWPNmCdfGR5OVr5jnGZw-uNGohwgjim-JYbSws/viewform';
                    newPlaceAddon = `?entry_839085807=${encodedTempSubmitName}&entry_1067461077=${encodedUrlSubmit}&entry_318793106=${
                        USER.name}&entry_1149649663=${encodedPlacePL}`;
        ...
        COLLEGE_ABBREVIATIONS.forEach(abbr => {
            ...
            if (anpNoneRE.test(newName) && _buttonBanner.areaNotPointLow) {
                _buttonBanner.areaNotPointLow.severity = 0;
                _buttonBanner.areaNotPointLow.WLactive = false;
            }
        });
    ...
    Object.keys(_buttonBanner).forEach(key => {
        if (_buttonBanner[key] && _buttonBanner[key].active) {
            severity = Math.max(_buttonBanner[key].severity, severity);
        }
    });

    if (!highlightOnly) {
        phlogdev(`Severity: ${severity}; lockOK: ${!noLock}`);
    }
    // Place locking
            ...
            if (_buttonBanner[tempKey] && _buttonBanner[tempKey].active) { //  If the particular message is active
                if (_buttonBanner[tempKey].hasOwnProperty('WLactive')) {
                    if (_buttonBanner[tempKey].WLactive) { // If there's a WL option, enable it
                        severity = Math.max(_buttonBanner[tempKey].severity, severity);
                    }
                } else {
                    severity = Math.max(_buttonBanner[tempKey].severity, severity);
                }
...
function assembleBanner() {
    ...
    Object.keys(_dupeBanner).forEach(tempKey => {
        ...
        if (rowData.active) {
            ...
            if (rowData.WLactive && rowData.WLaction) { // If there's a WL option, enable it
                severity = Math.max(rowData.severity, severity);
    ...
    Object.keys(_buttonBanner2).forEach(tempKey => {
        ...
        if (banner2RowData.active) { //  If the particular message is active
            ...
            rowDivs.push($rowDiv);
            severity = Math.max(_buttonBanner2[tempKey].severity, severity);
        }
    });
    ...
    if (venue && !$('#WMEPH-HideServicesButtons').prop('checked')) {
        ...
        if (!venue.isResidential()) {
            ...
            Object.keys(_servicesBanner).forEach(tempKey => {
                ...
                if (tempKey === 'addSecurity' && venue.isParkingLot()) {
                    rowData.active = true;
                } else if (tempKey === 'addEVCharging' && venue.isParkingLot()) {
                    rowData.active = true;
                }
                ...
                if (btn !== null) {
                    btn.onclick = () => {
                        ...
                        if ($('#WMEPH-WebSearchNewTab').prop('checked')) {
                            ...
                            window.open(openPlaceWebsiteURL, SEARCH_RESULTS_WINDOW_NAME, _searchResultsWindowSpecs);
                        }
                    };
                } else {
                    setTimeout(bootstrapRunButton, 100);
...
function getPanelFields() {
    ...
    for (let pfix = 0; pfix < panelFieldsList.length; pfix++) {
        ...
        if (pfa === 'name') {
            PANEL_FIELDS.name = pfix;
        }
        if (pfa === 'lockRank') {
            PANEL_FIELDS.lockRank = pfix;
        }
        if (pfa === 'description') {
            PANEL_FIELDS.description = pfix;
        }
        if (pfa === 'url') {
            PANEL_FIELDS.url = pfix;
        }
        if (pfa === 'phone') {
            PANEL_FIELDS.phone = pfix;
        }
        if (pfa === 'brand') {
            PANEL_FIELDS.brand = pfix;
        }
    }
    ...
    for (let pfix = 0; pfix < panelFieldsList.length; pfix++) {
        ...
        if (pfa.includes('landmark-edit-general')) {
            PANEL_FIELDS.navTabGeneral = pfix;
        }
        if (pfa.includes('landmark-edit-more')) {
            PANEL_FIELDS.navTabMore = pfix;
        }
    }
}
...
function initShortcutKey() {
    ...
    const defaultShortcutKey = IS_DEV_VERSION ? 'S' : 'A';
...
function reportError(data) {
    ...
    data.attach_sig = 'on';
    if (PM_USER_LIST.hasOwnProperty('WMEPH') && PM_USER_LIST.WMEPH.approvalActive) {
        data[`address_list[u][${PM_USER_LIST.WMEPH.modID}]`] = 'to';
        newForumPost('https://www.waze.com/forum/ucp.php?i=pm&mode=compose', data);
    } else {
        data.addbbcode20 = 'to';
        data.notify = 'on';
        newForumPost(`${URLS.forum}#preview`, data);
    }
